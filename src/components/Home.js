        ...
        <div className="card-div">        
          ...
          <div className="card-div">
            <section className="splash-card" style={{  width: '13rem', height: '15rem' }}>
             ...
             <Card.Title>Parcels<br></br> <Button variant="primary" size="sm" onClick={() => {
              ...
              <Card.Text>Keep track of parcels, which each contain one book. Click here to add, view, and edit sent parcels and mark returns.</Card.Text>
          </section>
          </div>
          ...
          <div className="card-div">
           <section className="splash-card" style={{  width: '13rem', height: '15rem' }}>
              ...
              <Card.Text> Manage our list of destination facilities. Click here to view or add to the list and view specific details about each.</Card.Text>
            </section>
          </div>
          ...
          <div className="card-div">
            <section className="splash-card" style={{  width: '13rem', height: '15rem' }}>
              ...
              <Card.Text>Some parcels are returned to us by the destination facility. Click here to view the list of books that have been returned.</Card.Text>
           </section>
          </div>
          ...
          <div className="card-div">
            <section className="splash-card" style={{  width: '13rem', height: '15rem' }}>
             <img src={Reports} />
              ...
              <Card.Text>Data about our most common destinations & genres, total books sent, and more can be found here.  
             </Card.Text>
            </section>
         </div>
